...
from utils.loss import compute_Ioss
from utils.loss import compute_my_loss
...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    hyp['obj'] *= (imgsz / 992) ** 2 * 3. / nl  # scale to image size and layers
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            with amp.autocast(enabled=cuda):
                ...
                loss, loss_items = compute_my_loss(pred, targets.to(device), model)  # loss scaled by batch_size
                if rank != -1:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/home/tmp/newR_yolo/without_2m+/r-yolo/runs/train/exp8/weights/last.pt', help='initial weights path')
